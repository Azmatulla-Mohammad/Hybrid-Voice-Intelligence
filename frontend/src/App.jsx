...
function App() {
  ...
  const isListening = edithState.isListening ?? false;
  const isSpeaking = edithState.isSpeaking ?? false;
  const isProcessing = edithState.isProcessing ?? false;
  const startListening = edithState.startListening;
  const submitCommand = edithState.submitCommand;
  const speechSupported = edithState.speechSupported ?? true;
  const messages = edithState.messages ?? [];
